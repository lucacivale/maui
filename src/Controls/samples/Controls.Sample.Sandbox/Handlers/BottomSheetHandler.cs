...
internal sealed partial class BottomSheetHandler
{
    ...
    private static readonly CommandMapper<IBottomSheet, BottomSheetHandler> BottomSheetCommandMapper = new CommandMapper<IBottomSheet, BottomSheetHandler>(ElementCommandMapper)
    {
